...
namespace Editor_de_Grafos
{
    public class GrafoBase : Panel
    {
        ...
        {
            Vertice v = getVerticeMarcado(); //Pega o vértice marcado.
            foreach (Vertice vertice in getAdjacentes(v.getNum()))
            {
                deleteAresta(v.getNum(), vertice.getNum()); //Remove todas as arestas ligadas a esse vértice.
            }
            setVerticeMarcado(null); //Desmarca o vértice
